...
[CustomEditor(typeof(Interact_Waypoint_Indicator)), CanEditMultipleObjects]
public class Interact_Waypoint_Indicator_Editor : Editor
{
    //Reference MonoBehaviour class in this script
    Interact_Waypoint_Indicator targetScript;

    public override void OnInspectorGUI()
    {
        //Do this first to make sure you have the latest version
        serializedObject.Update();
        targetScript = (Interact_Waypoint_Indicator)target;
        ...
        EditorGUILayout.Separator();
        serializedObject.FindProperty("enableSameDisable").boolValue = EditorGUILayout.Toggle("Enable Same Disable", targetScript.enableSameDisable);
